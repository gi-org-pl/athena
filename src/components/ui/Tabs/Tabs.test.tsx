...
describe('<Tabs />', () => {
  ...
  describe('Layout Calculation Mocking', () => {
    ...
    it('should calculate indicator style based on active element dimensions', () => {
      Object.defineProperty(HTMLElement.prototype, 'offsetLeft', { configurable: true, get: () => 120 });
      Object.defineProperty(HTMLElement.prototype, 'offsetWidth', { configurable: true, get: () => 85 });
