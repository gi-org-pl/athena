...
vi.mock("@/assets/icons/check-icon.svg", () => ({ default: () => <svg data-testid="check-icon" /> }));
vi.mock("@/assets/icons/info-icon.svg", () => ({ default: () => <svg data-testid="info-icon" /> }));
vi.mock("@/assets/icons/warning-icon.svg", () => ({ default: () => <svg data-testid="warning-icon" /> }));
vi.mock("@/assets/icons/x-icon.svg", () => ({ default: () => <svg data-testid="x-icon" /> }));

describe("Badge Component", () => {
    describe("Core Rendering", () => {
        it("should render the children correctly", () => {
        const { container } = render(<Badge dataTestId="badge-root">Active Status</Badge>);
        ...
        const { container } = render(<Badge dataTestId="badge-default">Default</Badge>);
...
describe("Icon Injection Logic", () => {
  ...
  describe("Dismiss Button Sizing Branches", () => {
    it("should apply small size classes to the dismiss button and icon", () => {
        render(<Badge isDismissible size="small">Small</Badge>);
    ...
    it("should apply big size classes to the dismiss button and icon", () => {
        render(<Badge isDismissible size="big">Big</Badge>);
        const button = screen.getByRole("button", { name: "Dismiss" });
        const icon = button.querySelector("svg");
  ...
  describe("Dismissible Functionality", () => {
    ...
    it("should fire the onDismiss callback when the button is clicked", () => {
      ...
      render(<Badge isDismissible onDismiss={handleDismiss}>Dismiss</Badge>);
    ...
    it("should prevent event propagation when clicking the dismiss button", () => {
      ...
      render(
        <div onClick={parentClick} data-testid="parent-container">
          <Badge isDismissible onDismiss={dismissClick}>Isolated</Badge>
        </div>
      );
