export const getTextAreaWrapperClasses = (
  ...
  const base =
    "w-full h-[122px] rounded-3xl border bg-transparent p-4 text-sm transition ease-[ease] duration-300 resize-none focus:outline-none focus:border-2";
  ...
  if (isError) {
    return `${base} border-gi-red text-gi-dark-primary placeholder:text-gi-gray hover:border-gi-red-hover focus:border-gi-red-hover`;
  }

  return `${base} border-gi-primary/10 text-gi-dark-primary placeholder:text-gi-gray hover:border-gi-primary/20 focus:border-gi-primary/20`;
};
