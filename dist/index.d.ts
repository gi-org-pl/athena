...
declare type TooltipAlign = "start" | "center" | "end";

declare interface TooltipProps extends Omit<HTMLAttributes<HTMLSpanElement>, "content"> {
    children: ReactNode;
    content: ReactNode;
    side?: TooltipSide;
    align?: TooltipAlign;
...
declare type TooltipSide = "top" | "right" | "bottom" | "left";
